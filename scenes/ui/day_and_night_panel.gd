...
func _on_normal_speed_button_toggled(toggled_on: bool) -> void:
	DayAndNightCycleManager.game_speed = normal_speed


func _on_fast_speed_button_toggled(toggled_on: bool) -> void:
	DayAndNightCycleManager.game_speed = fast_speed



func _on_cheetah_speed_button_toggled(toggled_on: bool) -> void:
